var j=Object.defineProperty;var z=(t,e,s)=>e in t?j(t,e,{enumerable:!0,configurable:!0,writable:!0,value:s}):t[e]=s;var M=(t,e,s)=>z(t,typeof e!="symbol"?e+"":e,s);import{i as N,a as h}from"./vendor-BUg1UuD4.js";(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))a(r);new MutationObserver(r=>{for(const i of r)if(i.type==="childList")for(const l of i.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&a(l)}).observe(document,{childList:!0,subtree:!0});function s(r){const i={};return r.integrity&&(i.integrity=r.integrity),r.referrerPolicy&&(i.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?i.credentials="include":r.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function a(r){if(r.ep)return;r.ep=!0;const i=s(r);fetch(r.href,i)}})();document.addEventListener("DOMContentLoaded",function(){const t=document.querySelector(".menu-btn"),e=document.querySelector(".close-btn-menu"),s=document.querySelector(".mobile-menu-backdrop"),a=document.querySelectorAll(".menu-item"),r=document.querySelector(".js-header-nav-list"),i=document.querySelector(".logo"),l=document.querySelectorAll(".nav-link"),f=document.querySelectorAll(".menu-link"),b=(o,c)=>{o.style.transition="all 300ms cubic-bezier(0.4, 0, 0.2, 1)",o.classList.toggle("js-nav-link-active",c);const m=o.closest(".nav-item");m&&(m.style.transition="all 300ms cubic-bezier(0.4, 0, 0.2, 1)",m.classList.toggle("js-nav-item-active",c))},d=()=>{const o=localStorage.getItem("activePath"),c=window.location.pathname,m=c==="/"||c==="/index.html",E=c==="/"?"./index.html":`./${c.split("/").pop()}`;l.forEach(v=>{const p=v.getAttribute("href");b(v,o&&p===o||!o&&m&&p==="./index.html"||!o&&!m&&p===E)}),f.forEach(v=>{const p=v.getAttribute("href"),$=o&&p===o||!o&&m&&p==="./index.html"||!o&&!m&&p===E;v.style.transition="color 300ms cubic-bezier(0.4, 0, 0.2, 1)",v.classList.toggle("active",$)})};t&&s&&t.addEventListener("click",()=>{s.style.transition="opacity 300ms ease, visibility 300ms ease",s.classList.add("is-open"),document.body.style.overflow="hidden"}),e&&s&&e.addEventListener("click",()=>{s.style.transition="opacity 300ms ease, visibility 300ms ease",s.classList.remove("is-open"),document.body.style.overflow=""}),a.forEach(o=>{const c=o.querySelector(".menu-link");c&&c.addEventListener("click",()=>{localStorage.setItem("activePath",c.getAttribute("href")),s&&(s.style.transition="opacity 300ms ease, visibility 300ms ease",s.classList.remove("is-open"),document.body.style.overflow=""),d()})}),r&&r.addEventListener("click",o=>{const c=o.target.closest(".nav-link");c&&(localStorage.setItem("activePath",c.getAttribute("href")),d())}),i&&i.addEventListener("click",()=>{localStorage.setItem("activePath","./index.html"),d()}),d()});const n={exerciseModal:document.querySelector("#exercise-modal"),exerciseContainer:document.querySelector(".exercise-container"),exercises:document.querySelector(".exercise-list"),exercisePageWrapper:document.querySelector(".exercise-page-wrapper"),searchForm:document.querySelector(".search-form"),quoteWrap:document.querySelector(".quote-wrap"),exercisesHeader:document.querySelector(".exercises-header"),filterBtnsList:document.querySelector(".filter-btns-list"),filterBtns:document.querySelectorAll(".js-filter-btn"),cardContainer:document.querySelector(".card-container"),categories:document.querySelector("#categories-container"),categoriesWrap:document.querySelector(".category-page-wrapper"),footerForm:document.querySelector(".footer-form"),giveRatingModal:document.querySelector("#give-rating-modal"),ratingBlock:document.querySelector(".rating-modal-rating-block"),ratingDisplay:document.querySelector(".rating-modal-rating"),scrollUp:document.querySelector(".scroll-to-top"),footerYear:document.querySelector(".footer-year")},x="https://your-energy.b.goit.study/api",ge={limit:8,page:1,maxPage:1,keyword:"",category_type:"muscles",category_name:"waist"},fe={Muscles:"muscles",Equipment:"equipment",Bodyparts:"bodypart"},P={},ve="Oops! We couldn't find any exercises matching your search. Try another keyword and keep moving! 💪";function g(t){return N.error({title:"Error",message:t,position:"topRight",transitionIn:"fadeInDown",timeout:3e3,close:!0})}function S(t){return N.success({title:"Success",message:t,position:"topRight",transitionIn:"fadeInDown",timeout:3e3,close:!0})}function J(t,e,s){const a=/^\w+(\.\w+)?@[a-zA-Z_]+?\.[a-zA-Z]{2,3}$/;return t?!e||!a.test(e)?(g("Please enter a valid email address."),!1):s?!0:(g("Please enter a comment."),!1):(g("Please select a rating before submitting."),!1)}function y(t,e){return t.length>e?t.slice(0,e-1)+"...":t}function F(t,e){return`${t} / ${e} min`}class _{async getExercises(){const{data:e}=await h.get(`${x}/exercises`);return e}async getExerciseById(e){try{const{data:s}=await h.get(`${x}/exercises/${e}`);return s}catch(s){throw g(`Error fetching exercise by ID: ${s}`),s}}async getExercisesWithParams({category_type:e,category_name:s,limit:a=8,page:r=1,keyword:i=""}){const l={[e]:s,limit:a,page:r};i&&(l.keyword=i);const{data:f}=await h.get(`${x}/exercises`,{params:l});return f}async updateRating(e,s){try{const{data:a}=await h.patch(`${x}/exercises/${e}/rating`,s);return a}catch(a){throw a}}}const w=class w{getFilterQuery(){return w.filterQuery===""?"Muscles":w.filterQuery}setFilterQuery(e){w.filterQuery=e}async fetchFilteredData(e,s,a){const r={filter:e,limit:s,page:a};return(await h.get(`${x}/filters`,{params:r})).data}};M(w,"filterQuery","");let D=w;class U{constructor(){M(this,"email","")}getFormData(){this.email=document.getElementById("email").value.trim()}verifyData(){return/^\w+(\.\w+)?@[a-zA-Z_]+?\.[a-zA-Z]{2,3}$/.test(this.email)?(document.getElementById("email").value="",!0):(g("Please enter a valid email address."),!1)}async postEmail(){try{const e=await h.post(`${x}/subscription`,{email:this.email})}catch(e){g(e.response.data.message);return}S("Email address added to subscriptions.")}}const L=class L{async getQuote(){const{data:e}=await h.get(`${x}/quote`);return e}setQuoteDataToLS(e,s=Date.now()){const a={quote:e,currentDate:s};localStorage.setItem(L.QUOTE_LS_KEY,JSON.stringify(a))}getQuoteDataFromLS(){return JSON.parse(localStorage.getItem(L.QUOTE_LS_KEY))}};M(L,"QUOTE_LS_KEY","quote-and-date");let T=L;const B=new _,pe=new D,ye=new U,I=new T;function K(t,e,s,a){t.innerHTML="";const r=2,i=2;function l(d){const o=document.createElement("button");return o.classList.add("page-number"),o.textContent=d,d===e&&(o.disabled=!0,o.classList.add("active")),o.addEventListener("click",a),o}const f=Math.max(1,e-r),b=Math.min(s,e+i);for(let d=f;d<=b;d++)t.appendChild(l(d))}const u="/advancedjs_group02/assets/icons-DsHkvW1c.svg";function O(t,e=!1){return t.map(s=>`<li class="exercise-item" data-id="${s._id}">
    ...
    <form data-id=${t} class="rating-modal-form">
      ...
      <button class="btn primary-btn" type="submit">
        Send
  ...
  </div>`}function V({_id:t,name:e,target:s,bodyPart:a,popularity:r,time:i,burnedCalories:l,rating:f,description:b,gifUrl:d,equipment:o}){var v;const m=Array.from({length:5},(p,$)=>`<svg class="exercise-modal-rating-icon ${$<Math.floor(f)?"rated":""}">
              <use href="${u}#star"></use>
            </svg>`).join(""),E=(v=localStorage.getItem("favorites"))==null?void 0:v.includes(t);return`<div data-id=${t} class="exercise-modal-card">
          ...
          `}async function Z(t){try{n.exerciseModal.classList.add("is-open"),n.exerciseModal.innerHTML='<div class="loader"></div>';const e=await B.getExerciseById(t),s=V(e);n.exerciseModal.innerHTML=s}catch(e){g(e.message)}}function X(t){var r;const s=((r=localStorage.getItem("favorites"))==null?void 0:r.includes(t))?`<button id="remove-from-favorites" class="btn btn-primary">
         Remove favorite
         <svg class="exercise-modal-btn-icon">
           <use href="${u}#trash"></use>
         </svg>
