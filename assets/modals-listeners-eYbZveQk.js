var H=Object.defineProperty;var N=(t,e,s)=>e in t?H(t,e,{enumerable:!0,configurable:!0,writable:!0,value:s}):t[e]=s;var E=(t,e,s)=>N(t,typeof e!="symbol"?e+"":e,s);import{a as y,i as C}from"./vendor-BUg1UuD4.js";(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))a(r);new MutationObserver(r=>{for(const i of r)if(i.type==="childList")for(const d of i.addedNodes)d.tagName==="LINK"&&d.rel==="modulepreload"&&a(d)}).observe(document,{childList:!0,subtree:!0});function s(r){const i={};return r.integrity&&(i.integrity=r.integrity),r.referrerPolicy&&(i.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?i.credentials="include":r.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function a(r){if(r.ep)return;r.ep=!0;const i=s(r);fetch(r.href,i)}})();document.addEventListener("DOMContentLoaded",function(){const t=document.querySelector(".menu-btn"),e=document.querySelector(".close-btn-menu"),s=document.querySelector(".mobile-menu-backdrop"),a=document.querySelectorAll(".menu-item"),r=document.querySelector(".js-header-nav-list"),i=document.querySelector(".logo"),d=document.querySelectorAll(".nav-link"),m=document.querySelectorAll(".menu-link"),w=(n,c)=>{n.style.transition="all 300ms cubic-bezier(0.4, 0, 0.2, 1)",n.classList.toggle("js-nav-link-active",c);const u=n.closest(".nav-item");u&&(u.style.transition="all 300ms cubic-bezier(0.4, 0, 0.2, 1)",u.classList.toggle("js-nav-item-active",c))},v=()=>{const n=localStorage.getItem("activePath"),c=window.location.pathname,u=c==="/"||c==="/index.html",L=c==="/"?"./index.html":`./${c.split("/").pop()}`;d.forEach(g=>{const p=g.getAttribute("href");w(g,n&&p===n||!n&&u&&p==="./index.html"||!n&&!u&&p===L)}),m.forEach(g=>{const p=g.getAttribute("href"),q=n&&p===n||!n&&u&&p==="./index.html"||!n&&!u&&p===L;g.style.transition="color 300ms cubic-bezier(0.4, 0, 0.2, 1)",g.classList.toggle("active",q)})};t&&s&&t.addEventListener("click",()=>{s.style.transition="opacity 300ms ease, visibility 300ms ease",s.classList.add("is-open"),document.body.style.overflow="hidden"}),e&&s&&e.addEventListener("click",()=>{s.style.transition="opacity 300ms ease, visibility 300ms ease",s.classList.remove("is-open"),document.body.style.overflow=""}),a.forEach(n=>{const c=n.querySelector(".menu-link");c&&c.addEventListener("click",()=>{localStorage.setItem("activePath",c.getAttribute("href")),s&&(s.style.transition="opacity 300ms ease, visibility 300ms ease",s.classList.remove("is-open"),document.body.style.overflow=""),v()})}),r&&r.addEventListener("click",n=>{const c=n.target.closest(".nav-link");c&&(localStorage.setItem("activePath",c.getAttribute("href")),v())}),i&&i.addEventListener("click",()=>{localStorage.setItem("activePath","./index.html"),v()}),v()});const o={exerciseModal:document.querySelector("#exercise-modal"),exerciseContainer:document.querySelector(".exercise-container"),exercises:document.querySelector(".exercise-list"),exercisePageWrapper:document.querySelector(".exercise-page-wrapper"),searchForm:document.querySelector(".search-form"),quoteWrap:document.querySelector(".quote-wrap"),exercisesHeader:document.querySelector(".exercises-header"),filterBtnsList:document.querySelector(".filter-btns-list"),filterBtns:document.querySelectorAll(".js-filter-btn"),cardContainer:document.querySelector(".card-container"),categories:document.querySelector("#categories-container"),categoriesWrap:document.querySelector(".category-page-wrapper"),footerForm:document.querySelector(".footer-form"),giveRatingModal:document.querySelector("#give-rating-modal"),ratingBlock:document.querySelector(".rating-modal-rating-block"),ratingDisplay:document.querySelector(".rating-modal-rating"),scrollUp:document.querySelector(".scroll-to-top"),footerYear:document.querySelector(".footer-year")},h="https://your-energy.b.goit.study/api",de={limit:8,page:1,maxPage:1,keyword:"",category_type:"muscles",category_name:"waist"},ue={Muscles:"muscles",Equipment:"equipment",Bodyparts:"bodypart"},me="Oops! We couldn't find any exercises matching your search. Try another keyword and keep moving! 💪";class Q{async getExercises(){const{data:e}=await y.get(`${h}/exercises`);return e}async getExerciseById(e){try{const{data:s}=await y.get(`${h}/exercises/${e}`);return s}catch(s){throw console.error("Error fetching exercise by ID:",s),s}}async getExercisesWithParams({category_type:e,category_name:s,limit:a=8,page:r=1,keyword:i=""}){const d={[e]:s,limit:a,page:r};i&&(d.keyword=i);const{data:m}=await y.get(`${h}/exercises`,{params:d});return m}async updateRating(e,s){try{const{data:a}=await y.patch(`${h}/exercises/${e}/rating`,s);return a}catch(a){throw a}}}const b=class b{getFilterQuery(){return b.filterQuery===""?"Muscles":b.filterQuery}setFilterQuery(e){b.filterQuery=e}async fetchFilteredData(e,s,a){const r={filter:e,limit:s,page:a};return(await y.get(`${h}/filters`,{params:r})).data}};E(b,"filterQuery","");let I=b;function f(t){return C.error({title:"Error",message:t,position:"topRight",transitionIn:"fadeInDown",timeout:3e3,close:!0})}function x(t){return C.success({title:"Success",message:t,position:"topRight",transitionIn:"fadeInDown",timeout:3e3,close:!0})}function W(t,e,s){const a=/^\w+(\.\w+)?@[a-zA-Z_]+?\.[a-zA-Z]{2,3}$/;return t?!e||!a.test(e)?(f("Please enter a valid email address."),!1):s?!0:(f("Please enter a comment."),!1):(f("Please select a rating before submitting."),!1)}function $(t,e){return t.length>e?t.slice(0,e-1)+"...":t}function B(t,e){return`${t} / ${e} min`}class j{constructor(){E(this,"email","")}getFormData(){this.email=document.getElementById("email").value.trim()}verifyData(){return console.log(this.email),/^\w+(\.\w+)?@[a-zA-Z_]+?\.[a-zA-Z]{2,3}$/.test(this.email)?(document.getElementById("email").value="",!0):(console.log(this.email),f("Please enter a valid email address."),!1)}async postEmail(){try{const e=await y.post(`${h}/subscription`,{email:this.email})}catch(e){f(e.response.data.message);return}x("Email address added to subscriptions.")}}const S=class S{async getQuote(){const{data:e}=await y.get(`${h}/quote`);return e}setQuoteDataToLS(e,s=Date.now()){const a={quote:e,currentDate:s};localStorage.setItem(S.QUOTE_LS_KEY,JSON.stringify(a))}getQuoteDataFromLS(){return JSON.parse(localStorage.getItem(S.QUOTE_LS_KEY))}};E(S,"QUOTE_LS_KEY","quote-and-date");let P=S;const D=new Q,ge=new I,fe=new j,A=new P,l="/advancedjs_group02/assets/icons-DsHkvW1c.svg";function z(t,e=!1){return t.map(s=>`<li class="exercise-item" data-id="${s._id}">
        ...
        <ul class="exercise-footer">
          <li>
            ...
            ${window.innerWidth<1440?$(B(s.burnedCalories,s.time),6):B(s.burnedCalories,s.time)}
          </li>
          <li>
