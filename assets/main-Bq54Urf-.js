var Q=Object.defineProperty;var N=(t,e,a)=>e in t?Q(t,e,{enumerable:!0,configurable:!0,writable:!0,value:a}):t[e]=a;var $=(t,e,a)=>N(t,typeof e!="symbol"?e+"":e,a);import{a as x,i as W}from"./vendor-BUg1UuD4.js";(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))r(i);new MutationObserver(i=>{for(const o of i)if(o.type==="childList")for(const l of o.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&r(l)}).observe(document,{childList:!0,subtree:!0});function a(i){const o={};return i.integrity&&(o.integrity=i.integrity),i.referrerPolicy&&(o.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?o.credentials="include":i.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function r(i){if(i.ep)return;i.ep=!0;const o=a(i);fetch(i.href,o)}})();document.addEventListener("DOMContentLoaded",function(){const t=document.querySelector(".menu-btn"),e=document.querySelector(".close-btn-menu"),a=document.querySelector(".mobile-menu-backdrop"),r=document.querySelectorAll(".menu-item"),i=document.querySelector(".js-header-nav-list"),o=document.querySelector(".logo"),l=document.querySelectorAll(".nav-link"),v=document.querySelectorAll(".menu-link"),b=(c,d)=>{c.style.transition="all 300ms cubic-bezier(0.4, 0, 0.2, 1)",c.classList.toggle("js-nav-link-active",d);const f=c.closest(".nav-item");f&&(f.style.transition="all 300ms cubic-bezier(0.4, 0, 0.2, 1)",f.classList.toggle("js-nav-item-active",d))},u=()=>{const c=localStorage.getItem("activePath"),d=window.location.pathname,f=d==="/"||d==="/index.html",P=d==="/"?"./index.html":`./${d.split("/").pop()}`;l.forEach(p=>{const y=p.getAttribute("href");b(p,c&&y===c||!c&&f&&y==="./index.html"||!c&&!f&&y===P)}),v.forEach(p=>{const y=p.getAttribute("href"),E=c&&y===c||!c&&f&&y==="./index.html"||!c&&!f&&y===P;p.style.transition="color 300ms cubic-bezier(0.4, 0, 0.2, 1)",p.classList.toggle("active",E)})};t&&a&&t.addEventListener("click",()=>{a.style.transition="opacity 300ms ease, visibility 300ms ease",a.classList.add("is-open"),document.body.style.overflow="hidden"}),e&&a&&e.addEventListener("click",()=>{a.style.transition="opacity 300ms ease, visibility 300ms ease",a.classList.remove("is-open"),document.body.style.overflow=""}),r.forEach(c=>{const d=c.querySelector(".menu-link");d&&d.addEventListener("click",()=>{localStorage.setItem("activePath",d.getAttribute("href")),a&&(a.style.transition="opacity 300ms ease, visibility 300ms ease",a.classList.remove("is-open"),document.body.style.overflow=""),u()})}),i&&i.addEventListener("click",c=>{const d=c.target.closest(".nav-link");d&&(localStorage.setItem("activePath",d.getAttribute("href")),u())}),o&&o.addEventListener("click",()=>{localStorage.setItem("activePath","./index.html"),u()}),u()});const s={exerciseModal:document.querySelector("#exercise-modal"),exerciseContainer:document.querySelector(".exercise-container"),exercises:document.querySelector(".exercise-list"),exercisePageWrapper:document.querySelector(".exercise-page-wrapper"),searchForm:document.querySelector(".search-form"),quoteWrap:document.querySelector(".quote-wrap"),exercisesHeader:document.querySelector(".exercises-header"),filterBtnsList:document.querySelector(".filter-btns-list"),filterBtns:document.querySelectorAll(".js-filter-btn"),cardContainer:document.querySelector(".card-container"),categories:document.querySelector("#categories-container"),categoriesWrap:document.querySelector(".category-page-wrapper"),footerForm:document.querySelector(".footer-form"),giveRatingModal:document.querySelector("#give-rating-modal"),ratingBlock:document.querySelector(".rating-modal-rating-block"),ratingDisplay:document.querySelector(".rating-modal-rating"),footerYear:document.querySelector(".footer-year")},h="https://your-energy.b.goit.study/api",n={limit:8,page:1,maxPage:1,keyword:"",category_type:"muscles",category_name:"waist"},_={Muscles:"muscles",Equipment:"equipment",Bodyparts:"bodypart"},O="Oops! We couldn't find any exercises matching your search. Try another keyword and keep moving! 💪";class U{async getExercises(){const{data:e}=await x.get(`${h}/exercises`);return e}async getExerciseById(e){try{const{data:a}=await x.get(`${h}/exercises/${e}`);return a}catch(a){throw console.error("Error fetching exercise by ID:",a),a}}async getExercisesWithParams({category_type:e,category_name:a,limit:r=8,page:i=1,keyword:o=""}){const l={[e]:a,limit:r,page:i};o&&(l.keyword=o);const{data:v}=await x.get(`${h}/exercises`,{params:l});return v}async updateRating(e,a){try{const{data:r}=await x.patch(`${h}/exercises/${e}/rating`,a);return r}catch(r){throw r}}}const L=class L{getFilterQuery(){return L.filterQuery===""?"Muscles":L.filterQuery}setFilterQuery(e){L.filterQuery=e}async fetchFilteredData(e,a,r){const i={filter:e,limit:a,page:r};return(await x.get(`${h}/filters`,{params:i})).data}};$(L,"filterQuery","");let D=L;function m(t){return W.error({title:"Error",message:t,position:"topRight",transitionIn:"fadeInDown",timeout:3e3,close:!0})}function w(t){return W.success({title:"Success",message:t,position:"topRight",transitionIn:"fadeInDown",timeout:3e3,close:!0})}function j(t,e,a){const r=/^\w+(\.\w+)?@[a-zA-Z_]+?\.[a-zA-Z]{2,3}$/;return t?!e||!r.test(e)?(m("Please enter a valid email address."),!1):a?!0:(m("Please enter a comment."),!1):(m("Please select a rating before submitting."),!1)}function q(t,e){return t.length>e?t.slice(0,e-1)+"...":t}class z{constructor(){$(this,"email","")}getFormData(){this.email=document.getElementById("email").value.trim()}verifyData(){return console.log(this.email),/^\w+(\.\w+)?@[a-zA-Z_]+?\.[a-zA-Z]{2,3}$/.test(this.email)?(document.getElementById("email").value="",!0):(console.log(this.email),m("Please enter a valid email address."),!1)}async postEmail(){try{const e=await x.post(`${h}/subscription`,{email:this.email})}catch(e){m(e.response.data.message);return}w("Email address added to subscriptions.")}}const S=class S{async getQuote(){const{data:e}=await x.get(`${h}/quote`);return e}setQuoteDataToLS(e,a=Date.now()){const r={quote:e,currentDate:a};localStorage.setItem(S.QUOTE_LS_KEY,JSON.stringify(r))}getQuoteDataFromLS(){return JSON.parse(localStorage.getItem(S.QUOTE_LS_KEY))}};$(S,"QUOTE_LS_KEY","quote-and-date");let F=S;const M=new U,H=new D,k=new z,C=new F;function T(t,e,a,r){t.innerHTML="";const i=2,o=2;function l(u){const c=document.createElement("button");return c.classList.add("page-number"),c.textContent=u,u===e&&(c.disabled=!0,c.classList.add("active")),c.addEventListener("click",r),c}const v=Math.max(1,e-i),b=Math.min(a,e+o);for(let u=v;u<=b;u++)t.appendChild(l(u))}const g="/advancedjs_group02/assets/icons-DsHkvW1c.svg";function A(t){return t.map(e=>`<li class="exercise-item" data-id="${e._id}">
      ...
      `,s.categories.appendChild(l)}),s.categoriesWrap.innerHTML="",r.totalPages>1&&T(s.categoriesWrap,t,r.totalPages,G)}catch{m("Failed to load exercise categories. Please try again later.")}}function G(t){const e=Number(t.target.textContent);B(e)}function V(t){s.filterBtns.forEach(e=>{e.classList.remove("active-filter-btn")}),t.target.nodeName==="BUTTON"&&(t.target.classList.add("active-filter-btn"),s.searchForm.classList.remove("active-search-form"),s.cardContainer.classList.remove("hidden"),s.exerciseContainer.classList.add("hidden"),s.exercisesHeader.innerHTML="Exercises",H.setFilterQuery(t.target.textContent.trim()),B())}async function Z(t){t.preventDefault(),k.getFormData(),k.verifyData()&&k.postEmail()}function X(){const t=new Date().getFullYear();s.footerYear.textContent=`@${t}`}function ee(t){return`<div class="container">
    <form data-id=${t} class="rating-modal-form">
      ...
      <button class="btn primary-btn" type="submit">
        Send
  ...
  </div>`}function te({_id:t,name:e,target:a,bodyPart:r,popularity:i,time:o,burnedCalories:l,rating:v,description:b,gifUrl:u,equipment:c}){var p;const f=Array.from({length:5},(y,E)=>`<svg class="exercise-modal-rating-icon ${E<Math.floor(v)?"rated":""}">
              <use href="${g}#star"></use>
          ...
          `}async function se(t){try{s.exerciseModal.classList.add("is-open"),s.exerciseModal.innerHTML='<div class="loader"></div>';const e=await M.getExerciseById(t),a=te(e);s.exerciseModal.innerHTML=a}catch(e){m(e.message)}}function ae(t){var i;const a=((i=localStorage.getItem("favorites"))==null?void 0:i.includes(t))?`<button id="remove-from-favorites" class="btn btn-primary">
         Remove favorite
         <svg class="exercise-modal-btn-icon">
      ...
      ${a}
      <button id="give-rating" class="btn btn-secondary">Give a rating</button>
    `)}function re(t){try{const e=localStorage.getItem("favorites");if(!e)localStorage.setItem("favorites",JSON.stringify([t])),w("Exercise added to favorites!");else{const a=JSON.parse(e);if(!a.includes(t))localStorage.setItem("favorites",JSON.stringify([...a,t])),w("Exercise added to favorites!");else{const r=a.filter(i=>i!==t);localStorage.setItem("favorites",JSON.stringify(r)),w("Exercise removed from favorites!")}}ae(t)}catch(e){m(e.message)}}function ie(){document.addEventListener("click",t=>{if(s.exerciseModal.classList.contains("is-open")){if((t.target===s.exerciseModal||t.target.closest(".close-modal-btn"))&&s.exerciseModal.classList.remove("is-open"),t.target.closest("#add-to-favorites")||t.target.closest("#remove-from-favorites")){const e=t.target.closest(".exercise-modal-card").dataset.id;re(e)}if(t.target.closest("#give-rating")){s.exerciseModal.classList.remove("is-open"),s.giveRatingModal.classList.add("is-open");const e=t.target.closest(".exercise-modal-card").dataset.id,a=ee(e);s.giveRatingModal.innerHTML=a,s.ratingBlock=document.querySelector(".rating-modal-rating-block"),s.ratingDisplay=document.querySelector(".rating-modal-rating"),oe()}}s.giveRatingModal.classList.contains("is-open")&&(t.target===s.giveRatingModal||t.target.closest(".close-modal-btn"))&&(s.giveRatingModal.classList.remove("is-open"),s.exerciseModal.classList.add("is-open"))})}function oe(){s.ratingBlock.addEventListener("change",t=>{if(t.target.name==="rating"){const e=parseInt(t.target.value,10);s.ratingDisplay.textContent=e.toFixed(1),s.ratingBlock.querySelectorAll(".rating-modal-rating-icon").forEach((r,i)=>{i<e?r.style.fill="rgba(var(--cl-orange))":r.style.fill="rgba(var(--cl-lighthouse), 0.2)"})}})}function ne(){document.addEventListener("click",t=>{if(t.target.closest(".exercise-header-button")){const e=t.target.closest(".exercise-item").dataset.id;se(e)}})}function ce(){document.addEventListener("submit",async t=>{var a,r;t.preventDefault();const e=t.target;if(e.classList.contains("rating-modal-form")){const i=new FormData(e),o=e.querySelector('input[name="rating"]:checked'),l=i.get("email"),v=i.get("comment");if(!j(o,l,v))return;const u={rate:Number(o.value),email:l,review:v},c=e.dataset.id;try{await M.updateRating(c,u),s.giveRatingModal.classList.remove("is-open"),w("Rating submitted successfully!")}catch(d){const f=((r=(a=d.response)==null?void 0:a.data)==null?void 0:r.message)||"An unknown error occurred";m(f)}}})}B();K();s.searchForm.addEventListener("submit",Y);s.filterBtnsList.addEventListener("click",V);s.footerForm.addEventListener("submit",Z);s.categories.addEventListener("click",J);X();document.addEventListener("DOMContentLoaded",()=>{ie(),ne(),ce()});document.addEventListener("keydown",t=>{t.key==="Escape"&&(s.exerciseModal.classList.contains("is-open")&&s.exerciseModal.classList.remove("is-open"),s.giveRatingModal.classList.contains("is-open")&&(s.giveRatingModal.classList.remove("is-open"),s.exerciseModal.classList.add("is-open")))});
//# sourceMappingURL=main-Bq54Urf-.js.map
